...
export class AspectService {
  ...
  public async loadAspect() {
    ...
    for (const aspectData of aspectDataList) {
      ...
      const aspectIns = await this.applicationContext.getAsync<MethodAspectInterface>(
  ...
  private async addAspect(
    aspectIns: MethodAspectInterface,
  ...
  public interceptPrototypeMethod(
    Clz: new (...args) => any,
    methodName: string,
    aspectObject: MethodAspectInterface | (() => MethodAspectInterface)
  ) {
