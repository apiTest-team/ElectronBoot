...
import { Autowired_BOOT_STARTER } from "../../constant";
import { isFunction } from "../../../utils";
import * as path from "path";
import { AutowiredBootstrapOptions } from "../../../interface";
/**
 * 启动类
 * @param opts 启动参数
 * @constructor
 */
export const AutowiredBootApplication = (opts?:AutowiredBootstrapOptions):ClassDecorator=>{
  return target => {
    // 设置默认配置文件
    ...
    // 保存启动配置参数
    saveClassMetadata(Autowired_BOOT_STARTER,bootStrapOptions,target)
    // 启动
